...
function preload() {
 ...
 modeloap = loadImage("Entregable - copia/modelos.png");
  ...
  modelo005 = loadModel("tablaa.obj");
  modelo006 = loadModel("brocarap.obj");
  modelo007 = loadModel("Robot_Hand_Modeling_Sketchfab.obj");
  ...
  texturaa = loadImage("textu.jpg")
  texturaa0 = loadImage("metal.jpg")
  texturaa1 = loadImage("madera.jpg")
  texturaa2 = loadImage("All_basecolor_adjustment0.png")
}
...
+ "El software Aspire es utilizado por una gran variedad de empresas y particulares para crear paneles decorativos y puertas, adornos ornamentales, carpintería a medida, molduras arquitectónicas, señalización dimensional, logotipos tallados de empresas, regalos y premios personalizados, además de muchas más aplicaciones.",width/2-250+10,-height/2+20+10,230-10,300+10);
  ...
  push();
  translate(width/2, height/2);
  gPoint9 = graphics1.screenPosition(-40, -10, 60);
  fill("#FF3464");
...
if(estado === 1){
  ...
  fill("#FF3464");
  text("Da click en Modelo Principal para iniciar",50,0)
  pop();
...
//templates
  ...
  //ellipse(20,20,15,15);
   ...
   if(state00 === true){
      ...
      fill("#FF3464");
      rect(20,410,rectSz-40,25,5);
      fill("#FF3464");
      rect(20,440,rectSz-40,25,5);

      textSize(15);
      fill(255);
      text("Color de Fondo Blanco",55,428);
      text("Color de Fondo Negro",55,458);

      strokeWeight(10);
      stroke(0);
      //point(20+rectSz/2-20,410+25/2);
      //point(20+rectSz/2-20,440+25/2);
      noStroke();
...
//////////////////////////////////////////////////////////////
      ...
      if(state001 === 0){
        ...
        if(state002 === true){
      myTextArea.position(rectSz+20,height-175);
    }else{

      myTextArea.position(-5000,-5000);
    }
      ...
      //point(width/2+50-40,height-40);
      //point(width/2+50,height-40);
      //point(width/2+50+40,height-40);

      if(mouseIsPressed){
        var dd02 = dist(mouseX,mouseY,width/2+50,height-40);
        if(dd02 <= 15){
          save("Imagen.png");
        }
      }
      ...
      if(state001 === 1){
        ...
        if(state002 === true){
      myTextArea.position(rectSz+20,height-175-192);
    }else{
      ...
      push();
      scale(0.8);
      image(capture,width+50,height-75-240);
      pop();
      ...
      strokeWeight(40);
      stroke("#5D6675");
      line(width/2+50-50,height-40-192,width/2+50+50,height-40-192);
      strokeWeight(5);
      stroke(0);
      notasap.resize(30,30);
      camarap.resize(30,30);
      modeloap.resize(30,30);
      image(notasap,width/2+50-40,height-40-192);
      image(camarap,width/2+50,height-40-192);
      image(modeloap,width/2+50+40,height-40-192);
      ...
      noStroke();
      fill("#E8E8E8");
      rect(rectSz,height-200,width,200);
      ...
      fill("#3A404A");
      ellipse(rectSz+50,height-200+50,30,30);
      ellipse(rectSz+120,height-200+50,30,30);
      ellipse(rectSz+190,height-200+50,30,30);



        if(mouseIsPressed){
        var dd03 = dist(mouseX,mouseY,width/2+50,height-40-192);
        if(dd03 <= 15){
          save("Imagen.png");
        }
      }
...
function mousePressed() {
  ...
  if (dist(mouseX, mouseY, 47+val,250) < 5) {
    ...
    if (dist(mouseX, mouseY, width/2+50+40,height-40) < 15) {
    state001 = 1;
  }

      if (dist(mouseX, mouseY, width/2+50+40,height-40-192) < 15) {
    state001 = 0;
  }
  ...
  if (dist(mouseX, mouseY, 120,100) < 25) {
    ...
    values0 = 8;
       ...
       if (dist(mouseX, mouseY, 20+rectSz/2-20,410+25/2) < 15) {
   colorFondo = color(255);
  }

         if (dist(mouseX, mouseY, 20+rectSz/2-20,440+25/2) < 15) {
   colorFondo = color(0);
  }
  ...
  if (dist(mouseX, mouseY, width/2+gPoint0.x,height/2+gPoint0.y) < botonSz) {
    ...
    estado = 6;
       ...
       if (dist(mouseX, mouseY,  rectSz+50,height-200+50) < 30) {
    estado = 0;
  }
  
       if (dist(mouseX, mouseY,  rectSz+120,height-200+50) < 30) {
    estado = 7;
  }
         if (dist(mouseX, mouseY,  rectSz+190,height-200+50) < 30) {
    estado = 8;
  }
    if (dist(mouseX, mouseY,  width/2+gPoint9.x,height/2+gPoint9.y) < botonSz) {
    estado = 9;
  }
